...
public class HuDongListAdapter extends BaseAdapter{
	...
	private Map<Integer,CommentAdapter>map = null;
	private Map<Integer,List>mapPinglun = null;
	public HuDongListAdapter(Context mContext, List<PostsInfo> posts, MyClickListener mListener) {
		this.posts = posts;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (info != null) {
			...
			CommentAdapter adapterComment = new CommentAdapter(mContext, list, position);

...
import com.car.shopping.entity.PicsInfo;
import com.car.shopping.entity.PostsInfo;
import com.car.shopping.entity.VideosInfo;
import com.car.shopping.utils.Dialog;
import com.car.shopping.utils.MyGridView;
import com.car.shopping.utils.Utils;
import com.car.shopping.utils.Dialog.DialogItemClickListener;
...
public class MyAboutHuDongListAdapter extends BaseAdapter {

	private Context mContext;
	private LayoutInflater inflater;
	private List<PostsInfo> posts;
	private MyHuDongClickListener mListener;
	private ListView mListView;
	private MyListView lv;
	private Map<Integer, AboutCommentAdapter> map = null;
	private String carType;
	private Map<Integer, List> mapPinglun = null;

	public MyAboutHuDongListAdapter(Context mContext, List<PostsInfo> posts, MyHuDongClickListener mListener, String carType) {
		this.posts = posts;
	...
	public void refresh(List<PostsInfo> posts, String carType) {
		this.posts = posts;
		this.carType = carType;
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			vp = new ViewHelp();
			convertView = inflater.inflate(R.layout.item_myhudong, null);
		...
		if (info != null) {
			...
			if (carType.equals("1")) {
				...
				vp.talkimg.setVisibility(View.GONE);
				vp.delete.setOnClickListener(mListener);
				vp.delete.setTag(position);
			} else {
				vp.talkimg.setVisibility(View.VISIBLE);
			...
			AboutCommentAdapter adapterComment = new AboutCommentAdapter(mContext, list, position);
			...
			vp.mylv.setOnItemLongClickListener(new OnItemLongClickListener() {
				...
				public boolean onItemLongClick(AdapterView<?> arg0, View v, final int num, long arg3) {
					// adapterComment.updateItemData(posts.get(position).getComments().get(num),
					// num);
					Dialog.showListDialog(mContext, "请选择", new String[] { "删除该条评论" }, new DialogItemClickListener() {
						...
						public void confirm(String result) {
							if (result.equals("删除该条评论")) {
								...
								intent.setAction("com.app.action.broadcast_myhudong");
	...
	public static abstract class MyHuDongClickListener implements OnClickListener {
	...
	private void updateItem(int index, int type) {
		...
		if (type == 2) {
//			MyListView mylv = (MyListView) view.findViewById(R.id.mylv);

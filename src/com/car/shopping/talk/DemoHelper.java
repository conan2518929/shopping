...
import com.car.shopping.entity.NickNameInfo;
import com.car.shopping.entity.StatusInfo;
import com.car.shopping.talk.db.DemoDBManager;
import com.car.shopping.talk.db.InviteMessgeDao;
import com.car.shopping.talk.db.UserDao;
import com.car.shopping.talk.domain.EmojiconExampleGroupData;
import com.car.shopping.talk.domain.InviteMessage;
import com.car.shopping.talk.domain.InviteMessage.InviteMesageStatus;
import com.car.shopping.talk.domain.RobotUser;
import com.car.shopping.talk.parse.UserProfileManager;
import com.car.shopping.talk.receiver.CallReceiver;
...
import com.car.shopping.talk.utils.PreferenceManager;
...
public class DemoHelper {
	...
	private EaseUser getUserInfo(String username) {
		...
		if (username.equals(EMClient.getInstance().getCurrentUser())){//设置自己的

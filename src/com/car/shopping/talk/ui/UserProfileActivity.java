...
import com.car.shopping.activity.TalkShopDetailActivity;
	...
	private void initListener() {
		...
		if(username != null){
    		if (username.equals(EMClient.getInstance().getCurrentUser())) {
    			String showName1 = AppContext.mSharedPref.getSharePrefString(SharedPrefConstant.REN_NAME,"");
    			shop_detail.setVisibility(View.GONE);
    			tvUsername.setText(showName1);
//    			tvUsername.setText(EMClient.getInstance().getCurrentUser());
    			EaseUserUtils.setUserNick(showName1, tvNickName);
                EaseUserUtils.setUserAvatar(this, username, headAvatar);
    		} else {
    			shop_detail.setVisibility(View.VISIBLE);
    			tvUsername.setText(nickName);
//    			tvUsername.setText(username);
//    			EaseUserUtils.setUserNick(username, tvNickName);
    			EaseUserUtils.setUserNick(nickName, tvNickName);
    			EaseUserUtils.setUserAvatar(this, username, headAvatar);
    			asyncFetchUserInfo(nickName);
    		}
    		shop_detail.setOnClickListener(this);
		}
	}
	...
	public void onClick(View v) {
		...
		case R.id.user_head_avatar:
			uploadHeadPhoto();
			break;
		case R.id.shop_detail:
//			if(!username.equals("")){
//				Bundle data = new Bundle();
//				data.putString("username", username);
//				Utils.goOtherWithDataActivity(UserProfileActivity.this,TalkShopDetailActivity.class,data);
//			}
			break;

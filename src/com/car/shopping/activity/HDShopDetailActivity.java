...
import com.car.shopping.adapter.HuDongDetailListAdapter;
import com.car.shopping.adapter.HuDongDetailListAdapter.MyDetailClickListener;
import com.car.shopping.adapter.HuDongListAdapter;
...
import com.car.shopping.entity.BaseData;
import com.car.shopping.entity.BaseHDListInfo;
import com.car.shopping.entity.BaseZanSCInfo;
import com.car.shopping.entity.CommentsInfo;
import com.car.shopping.entity.HDInfo;
import com.car.shopping.entity.PostsInfo;
import com.car.shopping.entity.StatusInfo;
import com.car.shopping.entity.ZanListInfo;
...
import com.car.shopping.widget.CircleImageView;
import com.car.shopping.widget.ContainsEmojiEditText;
	...
	public void onClick(View v) {
		...
		case R.id.send:// 发送消息
			...
			if (content.length() != 0) {
				...
				Utils.showShortToast(HDShopDetailActivity.this, "请输入评论内容...");
			}
			break;
		default:
			break;
	...
	private void getData(String url) {
		...
		StringRequest stringRequest = new StringRequest(Request.Method.POST, Constant.URL_TEST + url, new Response.Listener<String>() {
			...
			public void onErrorResponse(VolleyError volleyError) {
				dismissLoadingDialog();
				Utils.showText(HDShopDetailActivity.this, "网络访问失败");
			}
		}) {
			@Override
				...
				if (info != null) {
					...
					if (data != null) {
						...
						if (user_type.equals("user")) {
							...
							hd_shop.setVisibility(View.VISIBLE);
		...
		public void myOnClick(int position, View v) {
			...
			case R.id.play:
				...
				if (videoUrl != null && videoUrl.length() != 0) {
					...
					Utils.showText(HDShopDetailActivity.this, "没有播放视频...");
				}
				break;
			case R.id.soucang:
			...
			case R.id.talkimg:
				...
				if (name.equals(AppContext.mSharedPref.getSharePrefString(SharedPrefConstant.IM_NAME, ""))) {
					Utils.showShortToast(HDShopDetailActivity.this, "不能和自己聊天...");
					return;
				}

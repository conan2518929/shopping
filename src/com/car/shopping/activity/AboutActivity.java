...
import com.car.shopping.adapter.MyAboutHuDongListAdapter;
import com.car.shopping.adapter.MyAboutHuDongListAdapter.MyHuDongClickListener;
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (action.equals("com.app.action.broadcast_myhudong")) {
				...
				if(typeSend.equals("6")){
					...
					deleteCcomment(Urls.API_DELETE_COMMENT_POST,
							posts.get(clickPosition).getComments().get(huifuweizhi).getId());
				}
			}
		}
	}
